...
public class HelloController {
	...
	@PostMapping("/user")
	public Account postAccount(@RequestParam String username, double startingGBP, double startingBTC){
		matcher.createAccount(username, startingGBP, startingBTC);
		return matcher.getAccount(username);
	}

	@PostMapping("/order")
	public Order postOrder (@RequestParam String username, String action, double volume, double price) {
